...
def send_scan_report(analyses: list[dict], shortlist_df, cfg: dict):
    ...
    for a in analyses[:max_n]:
        ...
        # find matching row in shortlist
...
def send_earnings_alert(earnings_data: list[dict], cfg: dict):
